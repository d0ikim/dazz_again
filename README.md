...
- **공연 일정 달력** — 공연 목록을 월별 달력으로 표시, 공연장별 색상 구분과 범례 필터 제공, 연도/월 드롭다운으로 원하는 달로 바로 이동
...
- **이용 가이드 페이지** — 처음 방문한 사용자에게 서비스 취지와 핵심 기능 4가지를 안내 (홈 히어로/상단 메뉴에서 진입)
- **모바일 반응형 UI** — 768px 이하에서 햄버거 메뉴 + 슬라이드 드로어로 전환, 그리드 재배치, 검색창/협연 관계도 등 좁은 화면 대응

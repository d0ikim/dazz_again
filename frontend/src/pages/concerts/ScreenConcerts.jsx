...
export default function ScreenConcerts({ navigate }) {
  ...
  // 선택된 탭 + 검색어로 공연 필터링 (두 조건 모두 만족해야 표시)
        ...
        <div className="col" style={{ gap: 12 }}>
          {list.map((p) => (
            ...
            <div
              ...
              style={{ flexDirection: 'row', alignItems: 'center', gap: 16, padding: '14px 18px' }}
              onClick={() => navigate('concert-detail', { concertId: p.id })}
            >
              {/* 날짜 블록 — 왼쪽에 고정 너비로 배치 */}
              <div className="cc-date" style={{ minWidth: 42, flexShrink: 0 }}>
